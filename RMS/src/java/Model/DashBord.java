...
public class DashBord {
     ...
     private DashBordService dashservise=DashBordService.getInstance();
	  ...
	  public Menubar getMenubars() {
			...
			log.info("begin  dashbord");
			return dashservise.getAcessibilityMenbar(PersonalIds.empid, PersonalIds.grpid, PersonalIds.empid);
/*
